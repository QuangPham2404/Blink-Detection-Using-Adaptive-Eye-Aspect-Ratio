                ...
                if results.multi_face_landmarks:
                    ...
                    if frame_count_started and smoothen_value >= EAR_THRESH:
                        ...
                        if frame_count <= FRAME_THRESH:
                            ...
                            updated_EARThresh = round((highest_in_blink_sequence+(lowest_in_blink_sequence)*2)/2, 4)
...
for i, path in enumerate(video_paths):
    if i == 0:
        continue
        name = "bao"
        test_EARThresh[len(test_EARThresh)-1] = 0.0542
    elif i == 1:
        continue
        name = "nhien"
        test_EARThresh[len(test_EARThresh)-1] = 0.1231
    elif i == 2:
        name = "quang"
        test_EARThresh[len(test_EARThresh)-1] = 0.4963
    elif i == 3:
        continue
        name = "Fadahd"
        ...
        continue
        name = "Huy"
        test_EARThresh[len(test_EARThresh)-1] = 0.0397
