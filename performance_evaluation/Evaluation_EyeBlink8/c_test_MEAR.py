...
file_path = r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\performace_assessment\Evaluation_EyeBlink8\ab_calibratied_MEARs.txt"
...
for index, video_path in enumerate(EAR_paths):
    ...
    with open(f"result_MEAR_{index+1}.txt", "w") as file:
