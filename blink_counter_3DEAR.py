    ...
    min_tracking_confidence = 0.5) as face_mesh:
        ...
        while video_stream.isOpened():
            ...
            if results.multi_face_landmarks:
                ...
                mesh_points = np.array([np.multiply([p.x, p.y, p.z], [img_w, img_h, 1]).astype(int) for p in results.multi_face_landmarks[0].landmark])

                #helper function to calculate EAR of an eye
                def calculate_left_eye_EAR():
                    numerator = 0
                    denomenator = 0
                    numerator += euclidean_distance_3d(mesh_points[160], mesh_points[144])
                    numerator += euclidean_distance_3d(mesh_points[158], mesh_points[153])
                    numerator += euclidean_distance_3d(mesh_points[159], mesh_points[145])
                    numerator += euclidean_distance_3d(mesh_points[161], mesh_points[163])
                    numerator += euclidean_distance_3d(mesh_points[157], mesh_points[154])
                    denomenator += euclidean_distance_3d(mesh_points[33], mesh_points[133])
                    return float((numerator)/(5*denomenator))
                
                def calculate_right_eye_EAR():
                    numerator = 0
                    denomenator = 0
                    numerator += euclidean_distance_3d(mesh_points[387], mesh_points[373])
                    numerator += euclidean_distance_3d(mesh_points[385], mesh_points[380])
                    numerator += euclidean_distance_3d(mesh_points[386], mesh_points[374])
                    numerator += euclidean_distance_3d(mesh_points[384], mesh_points[381])
                    numerator += euclidean_distance_3d(mesh_points[388], mesh_points[390])
                    denomenator += euclidean_distance_3d(mesh_points[263], mesh_points[362])
