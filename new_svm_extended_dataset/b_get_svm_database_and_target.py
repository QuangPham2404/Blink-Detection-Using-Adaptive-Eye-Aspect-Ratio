# Define file paths
EAR_paths = [
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear1.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear2.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear3.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear4.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear5.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear6.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear7.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm_extended_dataset\_filtered_ear8.txt",
]
...
non_blink_database = []
for index, lst in enumerate(final_non_blink_frameID_lists):
    EAR_list = EAR_lists[index]
    for frameID in lst:
        frame_vector = EAR_list[frameID - 6 : frameID + 7]
...
with open("b_svm_exdataset_database.txt", "w") as file:
...
with open("b_svm_exdataset_target.txt", "w") as file:
    for ele in target:
        # Convert each sublist to a string where elements are space-separated
        line = ele
        # Write the string to the file with a newline character
