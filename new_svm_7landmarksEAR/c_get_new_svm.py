...
with open(r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\new_svm\b_new_svm_target.txt", "r") as file:
    target = []
    for line in file:
        try:
...
joblib.dump(clf, 'new_ear_svm_model.pkl')

# Load the model from the file (for later use)
clf = joblib.load('new_ear_svm_model.pkl')