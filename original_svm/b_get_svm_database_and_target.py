# Define file paths
EAR_paths = [
    r"c:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear1.txt",
    r"c:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear2.txt",
    r"c:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear3.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear4.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear5.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear6.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear7.txt",
    r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\ear8.txt",
]
...
target_path = r"c:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\zzz_target.txt"
...
for index, lst in enumerate(non_blink_frameID_lists):
    ...
    EAR_list = EAR_lists[index]
    #clarified_blink_frameID_list = clarified_blink_frameID_lists[index]
    for frameID in lst:
        try:
            if EAR_list[int(frameID)] != "None":
...
with open("b_svm_database.txt", "w") as file:
...
with open("b_svm_target.txt", "w") as file:
    for ele in target:
        # Convert each sublist to a string where elements are space-separated
        line = ele
        # Write the string to the file with a newline character
