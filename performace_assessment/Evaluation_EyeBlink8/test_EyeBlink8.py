...
file_path = r"C:\Users\STVN\Desktop\PYTHON\Thuc_tap_BK\blink_notification\performace_assessment\Evaluation_EyeBlink8\calibrated_EARs.txt"
...
blink_count_list = []
blink_sequence_frame_indexes_lists = []
for index, video_path in enumerate(EAR_paths):
    ...
    blink_count_list.append(blink_count)
    blink_sequence_frame_indexes_lists.append(blink_sequence_frame_indexes_list)
